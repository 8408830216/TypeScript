...
console.log("Maths marks :- ".concat(number1));
console.log("Physics marks :- ".concat(number2));
console.log("Chemistry marks :- ".concat(number3));
var a = +number1;
var b = +number2;
var c = +number3;
var sum = a + b + c;
...
console.log("==============================================================");
var arg = sum / 3;
console.log("Average of marks is :- ".concat(arg));
console.log("================================================================");
if (arg < 70) {
